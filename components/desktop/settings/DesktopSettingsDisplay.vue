<template>
  <div class="pt-6 border-t border-zinc-200/80 dark:border-zinc-800">
    <h3 class="text-desktop-micro text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-medium mb-5">화면 설정</h3>
    ...
    <div class="space-y-5">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-desktop-caption text-zinc-400 dark:text-zinc-500 mt-0.5">어두운 테마를 사용합니다</p>
        </div>
        <button
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-desktop-caption text-zinc-400 dark:text-zinc-500 mt-0.5">기본 입력 모드를 설정합니다</p>
        </div>
