<template>
  <div class="space-y-8">
    <!-- Group Info -->
    <div>
      <h4 class="text-desktop-micro text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-medium mb-4">그룹 정보</h4>
      <div>
    ...
    <!-- Invite Code -->
    <div v-if="inviteCode">
      <h4 class="text-desktop-micro text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-medium mb-4">초대 코드</h4>
