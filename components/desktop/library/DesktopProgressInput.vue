  ...
  <div class="flex items-center gap-3">
    ...
    <div class="relative flex-1">
      <input
        ...
        :disabled="disabled"
        class="w-full px-3 py-2.5 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl text-center text-lg font-semibold text-zinc-900 dark:text-white pr-10 focus:outline-none focus:ring-2 focus:ring-zinc-900/10 dark:focus:ring-white/10 focus:bg-zinc-100 dark:focus:bg-zinc-800 transition-all duration-200 ease-apple [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none disabled:opacity-40"
