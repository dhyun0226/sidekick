  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="flex items-center gap-2 mb-3">
        <div class="flex-1 bg-zinc-100 dark:bg-zinc-800 rounded-lg py-2 px-3 text-center font-bold text-lg text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-700">
          {{ inviteCode }}
        </div>
