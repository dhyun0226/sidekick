        ...
        <div class="relative w-full max-w-md max-h-[90vh] bg-white dark:bg-zinc-900 rounded-2xl shadow-apple-lg ring-1 ring-black/[0.04] dark:ring-white/[0.06] overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
          ...
          <div class="flex-1 overflow-y-auto">
            ...
            <div v-else-if="currentView === 'form'" class="p-6 space-y-5">
              <div>
                <label class="block text-[11px] font-bold text-zinc-400 uppercase mb-2">카테고리</label>
              ...
              <div>
                <label class="block text-[11px] font-bold text-zinc-400 uppercase mb-2">제목</label>
                <input
                  v-model="form.title"
                  type="text"
                  maxlength="100"
              ...
              <div>
                <label class="block text-[11px] font-bold text-zinc-400 uppercase mb-2">내용</label>
                <textarea
            ...
            <div v-else-if="currentView === 'detail' && selectedInquiry" class="p-6 space-y-5">
              <button @click="currentView = 'list'" class="flex items-center gap-1 text-xs font-bold text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
                <ChevronLeft :size="14" />
                목록으로
              </button>
              ...
              <div v-else class="text-center py-4">
                <p class="text-xs text-zinc-400">아직 답변이 등록되지 않았습니다</p>
              </div>
            </div>
          </div>
        </div>
